...
<center>
    ...
    <h3>Danh sách bài tập</h3>
        <table  class="table table-hover table-bordered" style="text-align: center; width: 80%;">
            <tr>
                <th>File</th>
                <th>Tùy chọn</th>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-primary" href="download2/<?php echo e($file->getFileName()); ?>">Tải về</a>
                    <?php if($role == 2): ?>
                        <a class="btn btn-danger" href="delete2/<?php echo e($file->getFileName()); ?>">Xóa</a>
                    <?php else: ?>
        ...
        <table class="table table-hover table-bordered" style="text-align: center; width: 80%;">
            ...
            <tr>
                <td><?php echo e($file->getFileName()); ?></td>
                <td>
                    <a class="btn btn-primary" href="download22/<?php echo e($file->getFileName()); ?>">Tải về</a>
                    <a class="btn btn-danger" href="delete3/<?php echo e($file->getFileName()); ?>">Xóa</a>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </table>
        <?php endif; ?>
...
<div id="id02" class="w3-modal">
    <div class="w3-modal-content w3-card-4 w3-animate-top">
        ...
        <form action="/submit/<?php echo e($id); ?>" style="margin-bottom:1rem;" method="POST" enctype="multipart/form-data">
            <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\challenge5b\resources\views/homework.blade.php ENDPATH**/ ?>